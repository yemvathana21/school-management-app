    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _menuItem(Icons.grade_rounded, 'My Grades', () {}, const Color(0xFF6C63FF)),
          _menuItem(Icons.calendar_month_rounded, 'Schedule', () {}, const Color(0xFF4ECDC4)),
          _menuItem(Icons.assignment_rounded, 'Assignments', () {}, const Color(0xFFFFA726)),
          _menuItem(Icons.bar_chart_rounded, 'Attendance Report', () {}, const Color(0xFF42A5F5)),
